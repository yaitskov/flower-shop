...
// The following option determines whether
// the "Show Blocks" feature is enabled or not at startup.
...
// FCKConfig.ProtectedSource.Add( /(<asp:[^\>]+>[\s|\S]*?<\/asp:[^\>]+>)|(<asp:[^\>]+\/>)/gi ) ;
// ASP.Net style tags <asp:control>
...
FCKConfig.LinkBrowserURL = FCKConfig.BasePath +
    ...
    encodeURIComponent( FCKConfig.BasePath + 'filemanager/connectors/'
                        + _FileBrowserLanguage + '/connector.'
...
FCKConfig.LinkUploadAllowedExtensions = // empty for all
    ".(7z|aiff|asf|avi|bmp|csv|doc|fla|flv|gif|gz|gzip|jpeg|jpg|mid|mov|mp3" +
    "|mp4|mpc|mpeg|mpg|ods|odt|pdf|png|ppt|pxd|qt|ram|rar|rm|rmi|rmvb|rtf|s" +
    "dc|sitd|swf|sxc|sxw|tar|tgz|tif|tiff|txt|vsd|wav|wma|wmv|xls|xml|zip)$" ;		
FCKConfig.LinkUploadDeniedExtensions	= "" ;	// empty for no one

FCKConfig.ImageUpload = true ;
FCKConfig.ImageUploadURL = FCKConfig.BasePath + 'filemanager/connectors/' +
    _QuickUploadLanguage + '/upload.' + _QuickUploadExtension + '?Type=Image' ;
// empty for all
...
FCKConfig.FlashUploadURL = FCKConfig.BasePath + 'filemanager/connectors/' +
    _QuickUploadLanguage + '/upload.' + _QuickUploadExtension + '?Type=Flash' ;
...
FCKConfig.SmileyImages	= [
    ...
    'confused_smile.gif','tounge_smile.gif','embaressed_smile.gif',
    'omg_smile.gif','whatchutalkingabout_smile.gif','angry_smile.gif',
    'angel_smile.gif','shades_smile.gif','devil_smile.gif','cry_smile.gif',
