...
/**
 * AlbumElement form base class.
 *
 * @method AlbumElement getObject() Returns the current form's model object
 *
 * @package    donbuket
 * @subpackage form
 ...
 */
abstract class BaseAlbumElementForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('album_element[%s]');
