...
/**
 * YearStatistic form base class.
 *
 * @method YearStatistic getObject() Returns the current form's model object
 *
 * @package    donbuket
 * @subpackage form
 ...
 */
abstract class BaseYearStatisticForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->validatorSchema->setPostValidator(
      new sfValidatorDoctrineUnique(array('model' => 'YearStatistic', 'column' => array('created_at')))
    );

    $this->widgetSchema->setNameFormat('year_statistic[%s]');
